    ...
    Box(
        ...
        Column(
            ...
            Column(
                modifier = modifier
                    .wrapContentWidth()
                    .padding(start = Dimens.dp120, end = Dimens.dp16)
                    .align(Alignment.End),
            ) {
                Text(
                    text = stringResource(id = R.string.track_check),
                    style = TextStyle(
                ...
                Text(
                    text = stringResource(id = R.string.checked_here),
                    style = TextStyle(
                        fontWeight = FontWeight.Bold,
        ...
        Box(
            modifier = modifier
                .padding(start = Dimens.dp32, top = Dimens.dp8)
                .wrapContentSize()
                .align(Alignment.TopStart),
        ) {
            Image(
                modifier = modifier.size(Dimens.dp90),
                painter = painterResource(id = R.drawable.search_widget),
